...
print (warming_red[1, 1, 4] - warming_red[0, 1, 4])
print (warming_red[1, 0, 4] - warming_red[0, 0, 4])
print (warming_red[1, 2, 4] - warming_red[0, 2, 4])
print ()
...
"""            #------------------------------------------------------->    figure here
################################################################################################################################################################
shreshold_list = np.arange(0,82,2)
ramprate_list  = np.arange(0, 0.082, 0.02)
need_country   = 0
table_used = table_WB[-6] 
